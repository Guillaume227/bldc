...
namespace commands{
  ...
  void process_packet(unsigned char *data, unsigned int len) {
      ...
      case COMM_SET_MCCONF:
          ...
          get_float32_auto(mcconf.l_current_max, data, &ind);
          get_float32_auto(mcconf.l_current_min, data, &ind);
          get_float32_auto(mcconf.l_in_current_max, data, &ind);
          get_float32_auto(mcconf.l_in_current_min, data, &ind);
          get_float32_auto(mcconf.l_abs_current_max, data, &ind);
          ...
          get_float32_auto(mcconf.l_min_vin, data, &ind);
          get_float32_auto(mcconf.l_max_vin, data, &ind);
          get_float32_auto(mcconf.l_battery_cut_start, data, &ind);
          get_float32_auto(mcconf.l_battery_cut_end, data, &ind);
          mcconf.l_slow_abs_current = data[ind++];
          get_float32_auto(mcconf.l_temp_fet_start, data, &ind);
          get_float32_auto(mcconf.l_temp_fet_end, data, &ind);
          get_float32_auto(mcconf.l_temp_motor_start, data, &ind);
          get_float32_auto(mcconf.l_temp_motor_end, data, &ind);
          get_float32_auto(mcconf.l_temp_accel_dec, data, &ind);
          get_float32_auto(mcconf.l_min_duty, data, &ind);
          get_float32_auto(mcconf.l_max_duty, data, &ind);
          get_float32_auto(mcconf.l_watt_max, data, &ind);
          get_float32_auto(mcconf.l_watt_min, data, &ind);
          ...
          get_float32_auto(mcconf.sl_max_fullbreak_current_dir_change, data, &ind);
          get_float32_auto(mcconf.sl_cycle_int_limit, data, &ind);
          get_float32_auto(mcconf.sl_phase_advance_at_br, data, &ind);
          ...
          get_float32_auto(mcconf.foc_encoder_ratio, data, &ind);
          ...
          get_float32_auto(mcconf.foc_motor_l, data, &ind);
          get_float32_auto(mcconf.foc_motor_r, data, &ind);
          get_float32_auto(mcconf.foc_motor_flux_linkage, data, &ind);
          get_float32_auto(mcconf.foc_observer_gain, data, &ind);
          get_float32_auto(mcconf.foc_observer_gain_slow, data, &ind);
          ...
          get_float32_auto(mcconf.foc_sl_d_current_duty, data, &ind);
          get_float32_auto(mcconf.foc_sl_d_current_factor, data, &ind);
          ...
          get_float32_auto(mcconf.foc_sat_comp, data, &ind);
          mcconf.foc_temp_comp = data[ind++];
          get_float32_auto(mcconf.foc_temp_comp_base_temp, data, &ind);
          get_float32_auto(mcconf.foc_current_filter_const, data, &ind);
          ...
          get_float32_auto(mcconf.p_pid_ang_div, data, &ind);

          get_float32_auto(mcconf.cc_startup_boost_duty, data, &ind);
          get_float32_auto(mcconf.cc_min_current, data, &ind);
          get_float32_auto(mcconf.cc_gain, data, &ind);
          get_float32_auto(mcconf.cc_ramp_step_max, data, &ind);

          // TODO: serialize as float format (check decoding end)
          mcconf.m_fault_stop_time_ms = millisecond_t(get_int32(data, &ind));
          get_float32_auto(mcconf.m_duty_ramp_step, data, &ind);
          get_float32_auto(mcconf.m_current_backoff_gain, data, &ind);
      ...
      case COMM_SET_APPCONF:
          ...
          get_float32_auto(appconf.timeout_brake_current, data, &ind);
          ...
          get_float32_auto(appconf.app_ppm_conf.pid_max_erpm, data, &ind);
          get_float32_auto(appconf.app_ppm_conf.hyst, data, &ind);
          get_float32_auto(appconf.app_ppm_conf.pulse_start, data, &ind);
          get_float32_auto(appconf.app_ppm_conf.pulse_end, data, &ind);
          get_float32_auto(appconf.app_ppm_conf.pulse_center, data, &ind);
          appconf.app_ppm_conf.median_filter = data[ind++];
          appconf.app_ppm_conf.safe_start = data[ind++];
          get_float32_auto(appconf.app_ppm_conf.throttle_exp, data, &ind);
          get_float32_auto(appconf.app_ppm_conf.throttle_exp_brake, data, &ind);
          get_enum(appconf.app_ppm_conf.throttle_exp_mode, data, &ind);
          get_float32_auto(appconf.app_ppm_conf.ramp_time_pos, data, &ind);
          get_float32_auto(appconf.app_ppm_conf.ramp_time_neg, data, &ind);
          ...
          get_float32_auto(appconf.app_adc_conf.hyst, data, &ind);
          get_float32_auto(appconf.app_adc_conf.voltage_start, data, &ind);
          get_float32_auto(appconf.app_adc_conf.voltage_end, data, &ind);
          get_float32_auto(appconf.app_adc_conf.voltage_center, data, &ind);
          get_float32_auto(appconf.app_adc_conf.voltage2_start, data, &ind);
          get_float32_auto(appconf.app_adc_conf.voltage2_end, data, &ind);
          ...
          get_float32_auto(appconf.app_adc_conf.throttle_exp, data, &ind);
          get_float32_auto(appconf.app_adc_conf.throttle_exp_brake, data, &ind);
          get_enum(appconf.app_adc_conf.throttle_exp_mode, data, &ind);
          get_float32_auto(appconf.app_adc_conf.ramp_time_pos, data, &ind);
          get_float32_auto(appconf.app_adc_conf.ramp_time_neg, data, &ind);
          ...
          get_float32_auto(appconf.app_chuk_conf.hyst, data, &ind);
          get_float32_auto(appconf.app_chuk_conf.ramp_time_pos, data, &ind);
          get_float32_auto(appconf.app_chuk_conf.ramp_time_neg, data, &ind);
          get_float32_auto(appconf.app_chuk_conf.stick_erpm_per_s_in_cc, data, &ind);
          get_float32_auto(appconf.app_chuk_conf.throttle_exp, data, &ind);
          get_float32_auto(appconf.app_chuk_conf.throttle_exp_brake, data, &ind);
