...
pin_map = \
'''
PC3 IN13 VOLTAGE1 IN0 PA0 
PB0 IN8  VOLTAGE2 IN1 PA1 
PA7 IN7  VOLTAGE3 IN2 PA2 
PC2 IN12 ADC_TEMP IN3 PA3 
PC4 IN14 TEMP_MOTOR  IN14	PC4 
?        ADC_EXT3	 IN15	PC5 
PA1 IN1 VBUS_SENSING/AN_IN IN13 PC3 

PA0 IN0  CURRENT1 IN10 PC0
PC1 IN11 CURRENT2 IN11 PC1
PC0 IN10 CURRENT3 IN12 PC2

PC9 GPIO_BEMF[Connect to GND] PC9

PB1 IN9 POTENTIOMETER IN9 PB1
